...
<div class="column is-half">
        ...
        <ul>
            ...
            <li>
                <a href="">
                    ...
                    <span>Agregar o Editar Estudiantes </span>
                </a>
            </li>
    </nav>
    ...
    <div class="block">
        ...
        <h1 class="subtitle">Agregar o Editar Nuevos Estudiantes</h1>
    </div>
    ...
    <div class="block">
        <div class="columns">
            <div class="column is-5">
                <form action="estudiante_crud.php?accion=INS" method="POST" enctype="multipart/form-data"
                    autocomplete="off">
                    <div class="field">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <a class="button is-info" data-taggle="tooltip" data-placement="top" title="Editar"
                                    href="
                                     = <?php echo $row['estudianteid'] ?>"> <i class="fas fa-edit"></i> </a> </td>
                            <td> <a class="button is-danger" data-taggle="tooltip" data-placement="top" title="Anular"
                                    href="estudiante_crud.php?accion=DLT%id = <?php echo $row['estudianteid'] ?>"> <i
